...
\def\@makechapterhead#1{%
  ...
  {\parindent \z@ \raggedright \normalfont
    ...
    \fi
    \interlinepenalty\@M
    \Huge \bfseries \fontfamily{SourceCodePro-TLF}\selectfont #1\par\nobreak
    \vskip 40\p@
}}

% For unnumbered chapters (\chapter*)
...
\chapter{04-zeros}
Solve the equation $\displaystyle \exp(7+ \tan^{-1} x) = 2x^2+2x+9.$
